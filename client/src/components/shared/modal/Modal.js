...
<div className="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-body">
        <div className="d-flex">
            ...
            <div className="form-check ms-3">
                <input type="radio" name="inRadio" defaultChecked className="default-check-input"
                value={'in'} onChange={(e)=>setInventoryType(e.target.value)}/>
               <label htmlFor="in" className="form-check-label">IN</label>
            </div>
            <div className="form-check ms-3">
                <input type="radio" name="inRadio"  className="default-check-input"
                value={'out'} onChange={(e)=>setInventoryType(e.target.value)}/>
      ...
      <InputType labelText={'Donor Email'} labelFor={'donor Email'} inputType={'email'}
